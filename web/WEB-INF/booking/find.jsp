...
<c:if test="${allowed == true}">
    ...
    <div class="about">
        ...
        <div class="property">
            <span class="label">Booking Start</span>
            <span class="data">${booking.getArrival()}</span>
        </div>
        <div class="property">
            <span class="label">Booking End</span>
        ...
        <div class="property link" onclick="window.location.href='/rooms/${booking.getRoom().getId()}';">
            <span class="label">Hall Number</span>
            <span class="data">${booking.getRoom().getNumber()}</span>
        </div>
        <div class="property">
            <span class="label">Total</span>
            <span class="data">Rs. ${booking.getTotal()}</span>
        </div>
    </div>
        ...
        <div class="payment-info">
            ...
            <div class="over">
                <table id="tablePayment">
                    ...
                    <c:forEach items="${paymentList}" var="payment">
                        <tr>
                            <td <c:if test="${allowed == true}">onclick="openModalPayment(${payment.getValue()}, '${payment.getPaymentMethod()}', ${booking.getTotal() - paid}, ${payment.getId()},'${payment.getStaff().getName()}')" </c:if>>Rs. ${payment.getValue()}</td>
            ...
            <div class="payment-result">
                <div class="property">
                    ...
                    <span class="data">Rs. ${paid}</span>
                </div>
                <div class="property">
                    <span class="label">Remaining</span>
                    <span class="data" id="transformButton">Rs. ${booking.getTotal() - paid}</span>
                </div>
                <div class="property">
...
<script>
    ...
    function openModalDeletePayment(id, value) {
        ...
        document.getElementById("pay-sure").innerHTML = "Delete payment Rs." + value + "?";
        currentPayId = id;
    }
