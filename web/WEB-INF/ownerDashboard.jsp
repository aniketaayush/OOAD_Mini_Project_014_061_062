...
<div class="content">
    ...
    <div id="revenues">
        ...
        <div class="property" style="grid-area: 2/1/3/2;">
            ...
            <span class="data">Rs. <span id="yearRevenues"></span></span>
        </div>

        <div class="property" style="grid-area: 2/2/3/3;">
            <span class="label">Week</span>
            <span class="data">Rs. <span id="weekRevenues"></span></span>
        </div>
        <div class="property" style="grid-area: 3/1/4/2;">
            <span class="label">Month</span>
            <span class="data">Rs. <span id="monthRevenues"></span></span>
        </div>
        <div class="property" style="grid-area: 3/2/4/3;">
            <span class="label">Today</span>
            <span class="data">Rs. <span id="dayRevenues"></span></span>
        </div>
    ...
    <div id="checks">
        <h2>Today</h2>
        <div class="property" style="grid-area: 2/1/3/2;">
            <span class="label">Expected Occupancies</span>
            <span class="data"><span id="expectedArrives"></span></span>
        </div>
        <div class="property" style="grid-area: 2/2/3/3;">
            <span class="label" style="padding-bottom: 17px">Expected&nbsp;Vacations</span>
