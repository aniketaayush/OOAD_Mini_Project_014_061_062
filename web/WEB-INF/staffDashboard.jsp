...
<div class="content">
    ...
    <div class="arrivals"><h1 class="number">${arrivalList.size()}</h1>Expected Occupancies</div>
    <div class="departures"><h1 class="number">${departureList.size()}</h1>Expected Vacations</div>
    <div class="over arrival">
        <table>
            <thead>
            <tr><th colspan="3">Expected Occupancies</th></tr>
            </thead>
            <tbody>
    ...
    <div class="over departure">
        <table>
            <thead>
            <tr><th colspan="3">Expected Vacations</th></tr>
            </thead>
            <tbody>
