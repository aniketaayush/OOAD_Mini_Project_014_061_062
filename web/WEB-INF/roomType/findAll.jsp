...
<div class="content">
    ...
    <div class="updateRoomType">
        <label for="arrival">Booking Start</label>
        <label for="departure">Booking End</label>
    ...
    <div class="over">
        <table>
            <thead>
                <tr><th>Name</th><th>Description</th><th>Daily Price</th><th>Available Halls</th></tr>
            </thead>
            <tbody>
            <c:forEach items="${roomTypeList}" var="roomType">
                <tr onclick="window.location.href='/roomTypes/${roomType.getId()}';"><td>${roomType.getName()}</td><td>${roomType.getDescription()}</td><td>Rs. ${roomType.getDailyPrice()}</td><td class="count"> - </td></tr>
            </c:forEach>
    ...
    <div class="submit">
        <button onclick="window.location.href='/roomTypes/new';">New Hall Type</button>
    </div>
    </c:if>
</div>
